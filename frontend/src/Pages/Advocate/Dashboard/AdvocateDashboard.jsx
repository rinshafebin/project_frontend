...
export default function AdvocateDashboard() {
  ...
  const stats = [
    { label: 'Active Cases', value: '24', icon: Briefcase, color: 'bg-blue-500', change: '+3 this week' },
    { label: 'Upcoming Hearings', value: '8', icon: Calendar, color: 'bg-purple-500', change: '3 this week' },
    { label: 'Pending Documents', value: '12', icon: FileText, color: 'bg-amber-500', change: '5 urgent' },
    { label: 'Total Clients', value: '47', icon: Users, color: 'bg-green-500', change: '+2 new' }
  ];
